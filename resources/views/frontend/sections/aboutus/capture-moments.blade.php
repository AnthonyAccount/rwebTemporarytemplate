<section class="relative  pb-10 overflow-hidden">
    <img src="{{ asset('frontend/about-us/Frame 992.png') }}" alt=""
        class="absolute right-0 bottom-0 w-72 md:w-[420px] ">

    <div class="max-w-7xl mx-auto px-4">

        <div class="mb-6 text-center max-w-4xl mx-auto">
            <p class="text-green-600 text-xs font-semibold mb-1">• Our Gallery</p>
            <h2 class="font-serif text-3xl font-bold text-gray-900">
                Captured Momentss in Villa's
            </h2>
            <p class="mt-3">Explone moments that showccase out spaces, services, and the memorable experiences we
                create for our
                guests.</p>
        </div>
        @php
